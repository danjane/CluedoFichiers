...
class Alibis:
    ...
    def __getitem__(self, key):
        ...
        switcher = {
            ...
            2: [f"Alibi: {pers} était dans {lieu}.", f"Alibi: Je suis certain que {arme} était dans {lieu}."],
            3: [f"Alibi: {pers} avait {arme}.", f"Alibi: Je suis certain que {arme} était dans {lieu}."]
        }
